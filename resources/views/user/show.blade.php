...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="container col-md-8 d-flex justify-content-between align-items-center mt-2 mb-5">
                <div class="avatar">
                    <img src="{{ $user->get_avatar }}" class="img-fluid">
                </div>
                <div class="user-info d-flex align-items-center flex-wrap">
                    <h1 class="mb-1">{{ $user->nick }}</h1>
                    <span class="posts mb-3 d-inline-block">{{ count($user->image) }} <strong>posts</strong></span>
                    <h2 class="mb-0">{{ $user->name }} {{ $user->lastname }}</h2>
                </div>
            </div>

            <div class="posts-container container d-flex justify-content-around flex-wrap">
                @foreach ( $user->image as $image )
                    <div class="card mt-4 post">
                        <div class="card-header">
                            ...
                            <a href="" class="container-fluid" style="padding-left: 0;">
                        ...
                        <div class="card-body p-0">
                            <figure style="max-height: 300px; overflow: hidden;" class="d-flex justify-content-center align-items-center">
